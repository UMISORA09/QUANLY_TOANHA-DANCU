      ...
      <div className="relative w-full max-w-3xl bg-white/95 backdrop-blur-2xl border border-white/90 rounded-2xl shadow-2xl p-6 text-neutral-900 z-10 max-h-[92vh] flex flex-col my-auto">
        ...
        <form onSubmit={handleSubmit} className="mt-4 flex-1 overflow-y-auto space-y-4 pr-1">
          ...
          <div className="p-4 bg-neutral-50/70 border border-neutral-200/70 rounded-xl space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs border border-neutral-300 rounded-lg bg-white text-neutral-900 font-medium focus:outline-none focus:ring-1 focus:ring-neutral-900"
                />
              </div>

              <div>
                <label className="block text-xs font-semibold text-neutral-700 mb-1">
                  Mã tiện ích <span className="text-rose-500">*</span>
                </label>
                <input
                  type="text"
                  required
                  placeholder="Mã tiện ích..."
                  value={amenityCode}
                  onChange={(e) => setAmenityCode(e.target.value.toUpperCase())}
                  className="w-full px-3 py-2 text-xs border border-neutral-300 rounded-lg bg-white text-neutral-900 uppercase font-mono font-medium focus:outline-none focus:ring-1 focus:ring-neutral-900"
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-neutral-700 mb-1">
                Vị trí chi tiết <span className="text-rose-500">*</span>
              </label>
              <input
                type="text"
                required
